...
public class BagTests
{
    ...
    public void Setup()
    {
        ...
        {
            new ComedyMovie("Animation comedy")
        };
    ...
    public void RemoveOneScreeningShouldKeepOthersIntact()
    {
        ...
        var screening2 = new Screening(
            2, _movie, _auditorium,
            DateTime.Now.AddDays(2),
            new TimeSpan(18, 0, 0),
            ScreeningFormat.IMAX,
            ScreeningVersion.Dubbing
        );

        var screening3 = new Screening(
            3, _movie, _auditorium,
    ...
    {
        new Screening(1, _movie, _auditorium, DateTime.Now.AddDays(1),
            new TimeSpan(10, 0, 0), ScreeningFormat.IMAX, ScreeningVersion.Original);

        new Screening(2, _movie, _auditorium, DateTime.Now.AddDays(1),
            new TimeSpan(14, 0, 0), ScreeningFormat._3D, ScreeningVersion.Dubbing);

        new Screening(3, _movie, _auditorium, DateTime.Now.AddDays(1),
            new TimeSpan(18, 0, 0), ScreeningFormat.IMAX, ScreeningVersion.Lector);
